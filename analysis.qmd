...
ggplot(data=data, aes(x=year, y=number_of_applications, group=department)) +
  geom_line(linewidth=0.6, color="black") +  # Black lines for consistency
  geom_point(size=1.2, color="black") +  # Black points
